...
var sendAddPaymentInfoEvent = require('../sendSubmitApplicationEvent');
var getFbQueue = require('../../helpers/getFbQueue.js');

describe('Send Submit Application Event module', function () {
  setupTests.setup();
  ...
  test('logs message to turbine', function () {
    ...
    expect(turbine.logger.log.mock.calls[0]).toEqual([
      'Queue command: fbq("track", "SubmitApplication", undefined) with' +
        ' eventId: 11111.'
    ]);
  });
});
