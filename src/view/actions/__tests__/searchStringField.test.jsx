...
import Event from '../sendSearchEvent';
...
const getField = () => screen.getByLabelText(/search string/i);

describe('Search String Field', () => {
  ...
  test('is set with the value from the previous settings property', async () => {
    renderView(Event);
