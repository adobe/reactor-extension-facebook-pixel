...
import Event from '../sendSubscribeEvent';
...
const getField = () =>
  screen.getByLabelText(/predicted lifetime value/i, {
    selector: '[name="predicted_ltv"]'
  });

describe('Predicted Lifetime value field', () => {
